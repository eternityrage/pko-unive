...
def upload_to_youtube(video_path, title, description, tags=None, category_id='22'):
    ...
    if tags is None:
        tags = ["parrot", "funnyparrot", "pickouniverse", "greenparrot", "funnyanimals", "birds", "talkingparrot", "parrotlife", "cutebirds", "animalhumor", "shorts", "reels"]
...
def main():
    ...
    title = "Picko Universe Daily"
    description = "#shorts #parrot #funny #pickouniverse"
    tags = ["parrot", "funnyparrot", "pickouniverse", "greenparrot"]
